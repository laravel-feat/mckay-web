...
<title>Jobs &#8211; Recruitment &#8211; Job Search &#8211; Employment
	&#8211; Job Vacancies &#8211; McKay</title>
<link rel='dns-prefetch' href='//fonts.googleapis.com' />
 
<link rel='stylesheet' 
	href='{{URL::asset('/public/css/style.css')}}'
	  />
<style>
html {
	font-size: 93.75%;
...
h1, .entry-content h1, h2, .entry-content h2, h3, .entry-content h3, h4,
...
#secondary, #secondary button, #secondary input, #secondary select,
	#secondary textarea {
	font-size: 15px;
	font-size: 1rem;
}
...
body, h1, .entry-title a, .entry-content h1, h2, .entry-content h2, h3,
	...
	.entry-content h6, .wc-block-grid__product-title {
	color: #3a3a3a;
}
...
input[type="radio"]:checked, input[type=reset], input[type="checkbox"]:checked,
	input[type="checkbox"]:hover:checked, input[type="checkbox"]:focus:checked,
...
.single .nav-links .nav-previous, .single .nav-links .nav-next, .single .ast-author-details .author-title,
	.ast-comment-meta {
	color: #0274be;
}
...
.entry-meta a:hover, .entry-meta a:hover *, .entry-meta a:focus,
	.entry-meta a:focus * {
	color: #3a3a3a;
}
...
.ast-pagination a:hover, .ast-pagination a:focus, .ast-pagination>span:hover:not
	(.dots ), .ast-pagination>span.current, .page-links>.page-link,
	.page-links .page-link:hover, .post-navigation a:hover {
	color: #3a3a3a;
}
...
.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit,
...
button:focus, .menu-toggle:hover, button:hover, .ast-button:hover,
	.button:hover, input[type=reset]:hover, input[type=reset]:focus, input#submit:hover,
	input#submit:focus, input[type="button"]:hover, input[type="button"]:focus,
...
@media ( min-width :769px) {
	...
	body.elementor-editor-active.ast-theme-transparent-header #masthead,
		.fl-builder-edit .ast-theme-transparent-header #masthead, body.vc_editor.ast-theme-transparent-header #masthead,
...
.ast-theme-transparent-header .main-header-menu ul.sub-menu li a,
	.ast-theme-transparent-header .main-header-menu ul.sub-menu li>.ast-menu-toggle
	{
	color: #1e73be;
}
...
<link rel='stylesheet' id='google-fonts-1-css'
	...
	media='all' />
<link rel='stylesheet'  
	href='{{URL::asset('public/assets/font-awesome/css/fontawesome.min.css')}}'
	media='all' />
<link rel='stylesheet'  
	href='{{URL::asset('public/assets/font-awesome/css/solid.css')}}'
	media='all' />
<link rel='stylesheet'  
	href='{{URL::asset('public/assets/font-awesome/css/brands.min.css')}}'
	media='all' />
<link rel='stylesheet'  
	href='{{URL::asset('public/assets/font-awesome/css/regular.min.css')}}'
	media='all' />
 
<script
	src='{{URL::asset('public/assets/font-awesome/css/regular.min.css')}}'></script>
<script
	src='{{URL::asset('public/js/jquery.min.js')}}'></script>
...
#menu-item-247 ul.sub-menu, #menu-item-156 ul.sub-menu {
	width: 100%;
}
...
div#wpcf7-f295-p286-o1 input, div#wpcf7-f295-p286-o1 textarea {
	background: transparent;
}

div#wpcf7-f295-p286-o1 textarea {
	height: 120px;
}

div#wpcf7-f295-p286-o1 input.wpcf7-form-control.wpcf7-submit {
	background: #0078E1;
	padding: 15px;
	display: block;
	width: 250px;
...
#wpcf7-f295-p286-o1 p:nth-child(4), #wpcf7-f295-p286-o1 p:nth-child(5) {
	margin: 15px 10px;
}

#wpcf7-f295-p286-o1 p:nth-child(2), #wpcf7-f295-p286-o1 p:nth-child(3) {
	width: 48%;
	float: left;
	margin: 15px 10px;
}
...
<body  
	class="home page-template-default page page-id-8 wp-custom-logo ast-desktop ast-page-builder-template ast-no-sidebar astra-2.3.4 ast-header-custom-item-inside ast-single-post ast-inherit-site-logo-transparent ast-theme-transparent-header astra elementor-default elementor-kit-10 elementor-page elementor-page-8">
	...
	<div class="hfeed site" id="page">
		...
		<header
			class="site-header ast-primary-submenu-animation-fade header-main-layout-1 ast-primary-menu-enabled ast-logo-title-inline ast-hide-custom-menu-mobile ast-menu-toggle-icon ast-mobile-header-inline"
			id="masthead" itemtype="https://schema.org/WPHeader"
			itemscope="itemscope">
							...
							<div class="ast-mobile-menu-buttons">
								...
								<div class="ast-button-wrap">
									<button type="button"
										...
										<span class="screen-reader-text">Main Menu</span> <span
										...
										<div class="main-navigation">
											<ul id="primary-menu"
												...
												<li id="menu-item-137"
													...
													href="#">Eng</a>
												<button class="ast-menu-toggle" role="button"
														aria-expanded="false">
													...
													<ul class="sub-menu">
														<li id="menu-item-138"
															...
															href="#">Ru</a></li>
														<li id="menu-item-139"
															class="menu-item menu-item-type-custom menu-item-object-custom menu-item-139"><a
															href="#">Cz</a></li>
														<li id="menu-item-140"
		...
		<div id="entry-content" class="site-content">
			@yield('content') 
		</div>
		<!-- #content -->
		...
		<footer class="site-footer" id="colophon"
			itemtype="https://schema.org/WPFooter" itemscope="itemscope">
...
.mg-wpsi a:hover i {
	color: #ffffff
								...
								<ul class="mg-wpsi">
									<li><a href="#" target="_self"><i class="mgicon-facebook3"></i></a></li>
									<li><a href="#" target="_self"><i class="mgicon-twitter3"></i></a></li>
									<li><a href="#" target="_self"><i class="mgicon-instagram"></i></a></li>
								</ul>
							</div>
...
var wpcf7 = {"apiSettings":{"root":"http:\/\/mckay.neuronsit.in\/wp-json\/contact-form-7\/v1","namespace":"contact-form-7\/v1"}};
	...
	<script
		src='http://mckay.neuronsit.in/wp-includes/js/wp-embed.min.js?ver=5.3.2'></script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/js/frontend-modules.min.js?ver=2.9.7'></script>
	<script
		src='http://mckay.neuronsit.in/wp-includes/js/jquery/ui/position.min.js?ver=1.11.4'></script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/lib/dialog/dialog.min.js?ver=4.7.6'></script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/lib/waypoints/waypoints.min.js?ver=4.0.2'></script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js?ver=5.3.6'></script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/lib/share-link/share-link.min.js?ver=2.9.7'></script>
	<script>
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","downloadImage":"Download image"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"version":"2.9.7","urls":{"assets":"http:\/\/mckay.neuronsit.in\/wp-content\/plugins\/elementor\/assets\/"},"settings":{"page":[],"general":{"elementor_global_image_lightbox":"yes","elementor_lightbox_enable_counter":"yes","elementor_lightbox_enable_fullscreen":"yes","elementor_lightbox_enable_zoom":"yes","elementor_lightbox_enable_share":"yes","elementor_lightbox_title_src":"title","elementor_lightbox_description_src":"description"},"editorPreferences":[]},"post":{"id":8,"title":"Jobs%20%E2%80%93%20Recruitment%20%E2%80%93%20Job%20Search%20%E2%80%93%20Employment%20%E2%80%93%20Job%20Vacancies%20%E2%80%93%20McKay","excerpt":"","featuredImage":false}};
</script>
	<script
		src='http://mckay.neuronsit.in/wp-content/plugins/elementor/assets/js/frontend.min.js?ver=2.9.7'></script>
	<script>
