...
<link rel="stylesheet"
	href="{{asset('public/backend/css/normalize.min.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/bootstrap.min.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/font-awesome.min.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/themify-icons.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/pe-icon-7-stroke.min.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/flag-icon.min.css')}}">
<link rel="stylesheet"
	href="{{asset('public/backend/css/cs-skin-elastic.css')}}">
<link rel="stylesheet" href="{{asset('public/backend/css/style.css')}}">
<link href="{{asset('public/backend/css/chartist.min.css')}}"
	rel="stylesheet">
<link href="{{asset('public/backend/css/jqvmap.min.css')}}"
	rel="stylesheet">

<link href="{{asset('public/backend/css/weather-icons.css')}}"
	rel="stylesheet" />
...
<body>
				...
				<div class="header-menu">
					...
					<div class="user-area dropdown float-right">
						<a href="#" class="dropdown-toggle active" data-toggle="dropdown"
							...
							src="{{asset('public/backend/images/admin_avatar.jpg')}}"
							alt="User Avatar">
						</a>
	...
	<!--  Chart js -->
	<script src="{{asset('public/backend/js/Chart.bundle.min.js')}}"></script>

	<!--Chartist Chart-->
	<script src="{{asset('public/backend/js/chartist.min.js')}}"></script>
	<script
		src="{{asset('public/backend/js/chartist-plugin-legend.min.js')}}"></script>

	<script src="{{asset('public/backend/js/jquery.flot.min.js')}}"></script>
	<script src="{{asset('public/backend/js/jquery.flot.pie.min.js')}}"></script>
	<script src="{{asset('public/backend/js/jquery.flot.spline.min.js')}}"></script>

	<script
		src="{{asset('public/backend/js/jquery.simpleWeather.min.js')}}"></script>
	<script src="{{asset('public/backend/js/weather-init.js')}}"></script>

	<script src="{{asset('public/backend/js/moment.min.js')}}"></script>
	<script src="{{asset('public/backend/js/fullcalendar.min.js')}}"></script>
	<script src="{{asset('public/backend/js/fullcalendar-init.js')}}"></script>
