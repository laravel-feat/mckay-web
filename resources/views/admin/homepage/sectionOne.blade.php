	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<strong>Section One</strong><small> Update</small>
			</div>
...
@foreach ($errors->all() as $error)
				...
				<form method="post" action="{{route('admin.homepage.sectionOne.post')}}"  enctype="multipart/form-data">
					@csrf
					...
					<div class=" form-group">
						@if(!empty( optional(@$data['subsection'][$itemNum])['image_path'])) <img
							src="{{asset("public/uploads/".(optional(@$data['subsection'][$itemNum])['image_path']))}}"
						width="150px"/> @endif
						...
						<div class="col-12 col-md-9">
							<input name="subsection[{{$itemNum}}][image]" type="file" id="file-input"
