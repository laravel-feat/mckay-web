...
<script type="text/javascript">
    ...
    function sendMsg(msg)
    {
        ...
        $.ajax({
          ...
          data:{"_token":"{{ csrf_token() }}","message":msg,"user_id":{{$model->id}}},
    ...
    { 
        $.ajax({
          ...
          data:{message_id:last_msg_id,user_id:{{$model->id}}},
          success:function(data)
          {
        ...
        <img src="{{asset('public/backend/images/admin_avatar.jpg')}}" alt="Avatar" class="avatar"> 
          <div class="sent_msg">
            <p>${d.message}</p>
          ...
          <div class="incoming_msg_img"> <img src="{{$model->getProfileImage()}}" alt="Avatar" class="avatar"> </div>
